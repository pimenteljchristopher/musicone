...
.controller('SearchItemCtrl', 
				['$scope','$state', '$timeout','$ionicLoading','$ionicHistory','$location','$ionicLoading', 'SoundCloudQuery', '$ionicModal', '$moment', 'KeyboardService','$stateParams','DataMusicone','$ionicHistory','DataMusicone',
				function( $scope, $state,$timeout,$ionicLoading,$ionicHistory,$location,  $ionicLoading,   SoundCloudQuery,  $ionicModal,   $moment ,  KeyboardService,$stateParams,DataMusicone,$ionicHistory,DataMusicone ) {

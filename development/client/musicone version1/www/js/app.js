...
angular.module('starter', ['ionic','ngCordova','plangular',  'angular-momentjs','starter.controllers','starter.services','LocalStorageModule','ngOpenFB'])
...
.run(function(
  ...
  ngFB) {
    ...
    ngFB.init({appId: '746820032119054'});
  ...
  setTimeout(function() {
    ...
    var adMobId = {
        admob_banner_key: 'ca-app-pub-3459564552160541/5192032111',
        admob_interstitial_key: 'ca-app-pub-3459564552160541/1533241712'
    };
    var adMobPosition = {
        BOTTOM_CENTER: 8
    };  
...
.config(function($stateProvider, $urlRouterProvider,plangularConfigProvider) {
  ...
  $stateProvider
   ...
   .state('signin', {
    ...
    .state('forget', {
      url: "/forget",
          templateUrl: "templates/sign/forget.html",
